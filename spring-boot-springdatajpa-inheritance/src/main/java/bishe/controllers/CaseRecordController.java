    ...
    public List<HashMap<String, String>> getCaseRecordAll() {
        ...
        for (final CaseRecordEntity caseRecordEntity : caseRecordEntities) {
            caseNameMap.add(new HashMap<String, String>() {{
                ...
                put("tempPatientId", patientInfoService.findByPatientId(
                        caseRecordEntity.getTempPatientId()).getPatientName());
                put("tempDoctorId", doctorInfoService.findByDoctorId(
                        caseRecordEntity.getTempDoctorId()).getDoctorName());
                put("tempDiseaseId", commonDiseaseInfoService.findByCommonDiseaseId(
                        caseRecordEntity.getTempDiseaseId()).getCommonDiseaseName());
                ...
                put("tempDoctorPrescriptionId", doctorPrescriptionService.findByDoctorPrescriptionId(
                        caseRecordEntity.getTempDoctorPrescriptionId()).getPrescriptionName());
                ...
                put("tempSyndromeId", syndromeTypesService.findBySyndromeId(
                        caseRecordEntity.getTempSyndromeId()).getSyndromeName());
                put("tempInquiryResultId", tbInquiryresultService.findByInquiryResultId(
                        caseRecordEntity.getTempInquiryResultId()).getInquiryResult());
            }});
        }
        return caseNameMap;
    }
